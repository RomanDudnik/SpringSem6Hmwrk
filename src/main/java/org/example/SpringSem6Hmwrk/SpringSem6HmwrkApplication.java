package org.example.SpringSem6Hmwrk;

import org.springframework.boot.SpringApplication;
import org.springframework.boot.autoconfigure.SpringBootApplication;

@SpringBootApplication
public class SpringSem6HmwrkApplication {
	/**
	 ...
	 * представлять из себя сервис для учета личных заметок.
	...
	public static void main(String[] args) {
		SpringApplication.run(SpringSem6HmwrkApplication.class, args);
	}
